...
def _action_value(value: object, default: TicketNextNode) -> str:
    if isinstance(value, TicketNextNode):
        return value.value
...
def _route_after_plan(state: AgentState) -> str:
    return _action_value(state.get("ticket_next_node"), TicketNextNode.END)


def _route_after_executor(state: AgentState) -> str:
    return _action_value(state.get("ticket_next_node"), TicketNextNode.REFLECT)
